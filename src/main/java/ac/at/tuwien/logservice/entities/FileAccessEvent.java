...
public class FileAccessEvent implements Comparable<FileAccessEvent>{
    ...
    public FileAccessEvent(String id, String timestamp, String detected, String eventID, Action hasAction, Host hasSourceHost, Host hasTargetHost, File hasSourceFile, File hasTargetFile, User hasUser, Program hasProgram) {
        this.id = id;
        this.timestamp = timestamp;
