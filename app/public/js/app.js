function sendIt() {
      ...
      //  var nodes = [{id: "start", label: 'start'}, {id: "end", label: 'end'}];
        ...
        for (var i = 0; i < json.length; i++) {
            ...
            edges.push({
                ...
                sourceHostname: json[i].sourceHost.value,
                targetHostname: json[i].targetHost.value,
                to: target,
                arrows: 'to',
    ...
    function fillEdgeInfo(result) {
        ...
        d.innerHTML = '<div style="padding-left: 10px;padding-top: 10px;">' +
            ...
            '<br /><b>Source-Host: </b>' + result[0].sourceHostname +
            '<br /><b>Target-Host: </b>' + result[0].targetHostname +
            /*
