...
arrTargetPaths=("/Users/Agnes/Desktop/test" "/Users/Agnes/Desktop/test-2"  "/Users/Agnes/Desktop/sample" "/Users/Agnes/Desktop/sample")
...
arrWaitTime=(60 30 15 7.5 3.75 1.88 1)
...
transformOperation(){
    ...
    calcRandom $((${#arrOps[@]}))
    operation=${arrOps[$num]}
    echo $operation
    transformOperation "$operation"
}

transformOperationRandomWait(){
    $1
    calcRandom $((${#arrWaitTime[@]}))
    waittime=${arrWaitTime[$num]}
    echo "wait" $waittime
    sleep $waittime
    echo "sleep" "'"$waittime"'" >> $eventScript
    calcRandom $((${#arrOps[@]}))
    operation=${arrOps[$num]}
    echo $operation
    transformOperationRandomWait "$operation"
}
